...
# buttons position
center_pos = [(210, 160), (310, 160), (390, 160), (475, 160)]
button_rad = [40, 35, 35, 35]
but_status = [False, False, False, False]
but_color_status = [False, False, False, False]
button_thickness = 1
...
capture.set(3, 640)  # Set horizontal resolution
capture.set(4, 480)
...
while True:
    ...
    # pub_commands_robot.publish(str(0))
    data_out_parameters = []
    ...
    with open("O_Sautenkov_cobotar-1.txt", "wb") as fp:
